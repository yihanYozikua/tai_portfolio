        ...
        <div className={everythingCss.kv_container}>
          ...
          <div className={everythingCss.paragraph_1_container}>
            ...
            <div className={everythingCss.paragraph_1_description_container}>
              <div className={everythingCss.paragraph_1_description_prop}>「Everything’s gonna be alright.」は世の中の人に勇気と支えを与えたいという想いで、</div>
              ...
              <div className={everythingCss.paragraph_1_description_prop}>新年の願いを込めて、この曲で伝えたい「Everything’s gonna be alright.」</div>
            </div>
